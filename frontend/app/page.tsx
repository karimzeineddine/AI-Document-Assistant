...
import { Eye, EyeOff, FileText, Sparkles, Lock, Mail } from "lucide-react"
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-card p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-md">
            ...
            Get instant insights and answers from your knowledge base.
          </p>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-foreground">AI-powered document analysis</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-md bg-primary/10">
                <FileText className="h-4 w-4 text-primary" />
              </div>
              <span className="text-sm text-foreground">Support for PDF, DOCX, TXT & more</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-md bg-primary/10">
